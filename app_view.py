    ...
    lyt = html.Div(children=[
        html.Div(id='init-viewport',className='large-display', children=[
            html.Div(className='container-fluid', children=[
                ...
                html.Div(className='row align-items-center justify-content-center', children=[
                    html.Div(id='Output', className='col-2', children=[
                ...
                html.Div(className='col-5', children=[
                    html.Div(className='container', children=[
                        html.Div(className='row align-items-center', children=[
                            html.Div(className='col-12 pt-3', children=[
                                html.Div(className='card shadow p-1 mb-3 bg-white rounded', children=[
                ...
                html.Div(className='col-5', children=[
                    html.Div(className='container', children=[
                        html.Div(className='row', children=[
                            html.Div(className='col-12 pt-3', children=[
                                html.Div(className='card shadow p-1 mb-1 bg-white rounded', children=[
